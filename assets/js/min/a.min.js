...
var ps={events:{},on:function(t,e){this.events[t]=this.events[t]||[],this.events[t].push(e)},off:function(t,e){if(this.events[t])for(var s=0;s<this.events[t].length;s++)if(this.events[t][s]===e){this.events[t].splice(s,1);break}},emit:function(t,e){this.events[t]&&this.events[t].forEach(function(t){t(e)})}};
!function(o){"use strict";function e(){(void 0===d.money||void 0===d.soda||void 0===d.price)&&(d.money=0,d.soda=0,d.price=30),r.html(d.money),c.html(d.soda),s.html(d.price/10)}function n(){d.money=0,d.soda=0,d.price=30,a()}function t(e){var n=o(e.target).closest(".gen"),t=n.attr("what");"soda"===t?(d.soda=Number(d.soda)+1,a()):"money"===t&&(d.soda>=1?(d.soda=Number(d.soda)-1,d.money=Math.round(Number(d.money)+d.price/10),a()):alert("You haven't got enough soda! Go get some first!"))}function a(){r.html(d.money),c.html(d.soda),s.html(d.price/10)}var r=o("#money"),c=o("#soda"),s=o("#price"),i=o(".gen svg"),m=o("#reset"),d=localStorage;o(document).ready(function(){e(),i.on("click",t),m.on("click",n)})}(jQuery);
!function(n){"use strict";var o=function(){function o(){var o=n(this);o.on("mousedown",function(){o.css({"box-shadow":"2px 2px 10px .1rem rgba(0,0,0,.7) inset"})}),o.on("mouseup",function(){o.css({"box-shadow":"none"})})}var s=n(".gen svg");s.on("click",o)},s=function(){function o(){var o=n(this),s=o.offset.top;o.toggleClass("d"),o.siblings().removeClass("d"),o.css({top:"-"+s+"px"})}var s=n(".item");s.on("click",o)};n(document).ready(function(){o(),s()})}(jQuery);